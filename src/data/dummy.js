...
const meals = [
    ...
    {id: 2, name: 'Chicken Avocado Wrap', userId: 1, ingredients: [{foodId: 1, units: 0.675}, {foodId: 9, units: 0.167}, {foodId: 12, units: 2}]},
    {id: 3, name: 'Egg Avocado Wrap', userId: 1, ingredients: [{foodId: 3, units: 2}, {foodId: 9, units: 0.167}, {foodId: 12, units: 2}]},
    {id: 4, name: 'Salmon Quinoa Kimchi Bowl', userId: 1, ingredients: [{foodId: 2, units: 2}, {foodId: 10, units: 1}, {foodId: 15, units: 1}]},
    {id: 5, name: 'Chicken Teriyaki Bowl', userId: 1, ingredients: [{foodId: 1, units: 0.675}, {foodId: 10, units: 1}]},
]
